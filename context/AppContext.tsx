...
import { AppAction, AppSettings, Part2State } from '../types';
...
function sanitizeState(value: unknown): Partial<Part2State> {
  if (!value || typeof value !== 'object') return {};
  const raw = value as Partial<Part2State>;
...
function reducer(state: Part2State, action: AppAction): Part2State {
  switch (action.type) {
    case 'SET_VIEW':
